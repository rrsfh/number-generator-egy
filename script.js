...
function submitNumber() {
  ...
  const scriptURL = 'https://script.google.com/macros/s/AKfycbyxYoCabj77co_udciwO6y5CwQsDcRUf7TScsBxKdYbgaARvwnwvO3lgWC2oL4ncWzxXQ/exec'
...
function showAlert(tabName) {
  ...
  switch (tabName) {
    case 'Home':
      message = "مرحبًا بك في مولد الأرقام. يرجى اتباع التعليمات على الشاشة للانتقال إلى الجزء التالي من دراستنا.";
      break;
    case 'Instructions':
      message = "التعليمات: قم بتوليد رقم لاستخدامه في تجربتك. تأكد من حفظ الرقم لأنه ستحتاج إليه لاحقًا.";
      break;
    case 'Contact':
      message = "إذا واجهت صعوبة في هذه الصفحة، يرجى التواصل معنا عبر BeSample وسنقدم المساعدة في أسرع وقت ممكن.";
      break;
    default:
